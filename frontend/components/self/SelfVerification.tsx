    ...
    try {
      ...
      if (process.env.NODE_ENV === "development") {
        console.log("[Self] Configuring verification:", {
          ...
          endpointType,
          scope: process.env.NEXT_PUBLIC_SELF_SCOPE || "ajosave-savings",
          isMainnet,
        });
      }
      ...
      const app = new SelfAppBuilder({
        version: 2,
        appName: process.env.NEXT_PUBLIC_SELF_APP_NAME || "AjoSave",
        scope: process.env.NEXT_PUBLIC_SELF_SCOPE || "ajosave-savings",
        endpoint: apiEndpoint,
        ...
        userIdType: "hex",
        userDefinedData: `AjoSave Verification - ${address}`,
        disclosures: {
